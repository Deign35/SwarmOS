...
export class Kernel implements IKernel, IKernelExtensions, IKernelSleepExtension {
    ...
    createProcess(pid: PID): IProcess {
        this.log.debug(`ConstructProcess ${pid}`);
        ...
        let context: IProcessContext = {
            ...
            get isActive() {
                return kernelContext.processTable[pid] && !kernelContext.processTable[pid].end;
            },
            get pPID() {
                return kernelContext.processTable[pid] && kernelContext.processTable[pid].pP || "";
            },
            get memory() {
        ...
        this._processCache[pid] = process;
        return process;
    }
